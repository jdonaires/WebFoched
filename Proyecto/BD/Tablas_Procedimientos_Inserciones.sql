...
INSERT  INTO `usuario`(`Id_Usuario`,`Nombre`,`Pass`,`Correo`,`Rol`,`Fecha_Creacion`,`Estado`) VALUES 
(75813761,'Nombre 1',SHA1('Admin'),'xxever28xx@gmail.com','Admin','2018-12-03 22:30:18','1'),
(75813762,'Nombre 2',SHA1('Normal'),'ever28@gmail.com','Normal','2018-12-03 22:30:18','1'),
(75813763,'Nombre 3',SHA1('Normal'),'admin@gmail.com','Normal','2018-12-03 22:37:28','1');
...
BEGIN
		SELECT * FROM Usuario WHERE Usuario.Nombre = _Usuario
		OR Usuario.Id_Usuario = _Usuario AND Usuario.Estado = '1';
	END */$$
DELIMITER ;
...
BEGIN
	IF _Rol = 'Admin' THEN 
		INSERT INTO Usuario (Id_Usuario,Nombre,Pass,Correo,Rol,Fecha_Creacion) 
		VALUES (_Id_Usuario,_Nombre,SHA1(_Pass),_Correo,_Rol,NOW());
	ELSE
		INSERT INTO Usuario (Id_Usuario,Nombre,Pass,Correo,Fecha_Creacion) 
		VALUES (_Id_Usuario,_Nombre,SHA1(_Pass),_Correo,NOW());
	END IF;
	END */$$
DELIMITER ;
